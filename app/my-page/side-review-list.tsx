...
export default function SideReviewList({ uid }: { uid: string }) {
  ...
  return (
    <section className="group relative hidden lg:ml-8 lg:block lg:w-3/5">
      ...
      <span className="absolute left-1 top-1 -z-10 h-full w-full rounded-xl bg-[#701832] transition-all duration-300 group-hover:translate-x-1 group-hover:translate-y-1" />
    </section>
  );
}
