  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 hidden overflow-hidden md:block">
        ...
        <div className="absolute -bottom-4 -right-4 h-96 w-96 animate-pulse rounded-full bg-gradient-to-r from-blue-500/10 to-purple-500/10 blur-3xl animation-delay-2000"></div>
        <div className="absolute left-1/4 top-1/2 h-48 w-48 animate-bounce rounded-full bg-gradient-to-r from-pink-500/5 to-yellow-500/5 blur-2xl animation-delay-1000"></div>
      </div>
        ...
        <div className="mx-auto w-full max-w-6xl">
          <div className="mb-16">
            <div className="pb-10 md:pb-8">
              <div className="mb-2 flex animate-fade-in-up items-center justify-center space-x-3 md:justify-start">
                <div className="flex space-x-1">
                  <div className="h-2 w-2 animate-pulse rounded-full bg-accent-300"></div>
                  <div className="h-2 w-2 animate-pulse rounded-full bg-accent-300 animation-delay-200"></div>
                  <div className="h-2 w-2 animate-pulse rounded-full bg-accent-300 animation-delay-400"></div>
                  <div className="h-2 w-2 animate-pulse rounded-full bg-accent-300 animation-delay-600"></div>
                </div>
              ...
              <p className="animate-fade-in-up text-center text-base text-gray-300 animation-delay-300 md:ml-14 md:text-left">
                오늘의 추천 영화
              </p>
            </div>

            <div className="flex w-full animate-fade-in-up justify-center animation-delay-500">
